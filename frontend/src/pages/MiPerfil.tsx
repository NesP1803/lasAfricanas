        ...
        <div className="flex items-start justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-slate-500">
              Estos datos se usan para identificarte en el sistema.
            </p>
          </div>
          <button
            type="button"
          ...
          <label className="space-y-2 text-sm font-medium text-slate-700">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                aria-label={mostrarNuevaClave ? 'Ocultar clave' : 'Mostrar clave'}
              >
          ...
          <label className="space-y-2 text-sm font-medium text-slate-700">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="rounded-lg border border-slate-200 px-2 py-2 text-xs font-semibold text-slate-600 hover:border-blue-200 hover:text-blue-600"
                aria-label={mostrarConfirmarClave ? 'Ocultar clave' : 'Mostrar clave'}
              >
                {mostrarConfirmarClave ? <EyeOff size={14} /> : <Eye size={14} />}
              </button>
            </div>
          </label>
        </div>
