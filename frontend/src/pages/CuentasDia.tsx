        ...
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div>
            <h2 className="text-xl font-semibold text-slate-900">
              Detalles de la cuenta del día
            </h2>
            <p className="text-sm text-slate-500">
              Resumen consolidado de facturas y remisiones dentro del rango seleccionado.
            </p>
          </div>
        ...
        <div className="grid gap-4 lg:grid-cols-[1.15fr,0.85fr]">
          <div className="grid gap-4">
            <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
              ...
              <div className="mt-4 grid gap-3 text-sm text-slate-600">
                ...
                <div className="flex items-center justify-between rounded-lg border border-slate-200 bg-white px-3 py-2">
                  <span>Recaudado en facturas</span>
                  <span className="font-semibold text-slate-900">
                    {currencyFormatter.format(facturasValor)}
                  </span>
                </div>
            ...
            <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
              ...
              <div className="mt-4 grid gap-3 text-sm text-slate-600">
                <div className="flex items-center justify-between rounded-lg border border-slate-200 bg-white px-3 py-2">
                  <span>Documentos remitidos</span>
                  <span className="font-semibold text-slate-900">
                    {stats?.total_remisiones ?? 0}
                  </span>
                </div>
                <div className="flex items-center justify-between rounded-lg border border-slate-200 bg-white px-3 py-2">
                  <span>Recaudado en remisiones</span>
                  <span className="font-semibold text-slate-900">
                    {currencyFormatter.format(remisionesValor)}
                  </span>
                </div>
          ...
          <div className="flex h-full flex-col justify-between gap-4 rounded-2xl border border-slate-200 bg-white p-4">
            <div>
              ...
              <p className="mt-2 text-sm text-slate-500">
                Sumatoria de facturas y remisiones para el rango actual.
              </p>
            </div>
            <div className="rounded-xl border border-blue-100 bg-blue-50 px-4 py-3 text-sm text-blue-700">
              Este detalle se actualiza con cada venta registrada.
            </div>
          </div>
        </div>
      </section>
