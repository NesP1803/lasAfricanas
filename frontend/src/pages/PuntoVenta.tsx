...
export default function PuntoVenta() {
  ...
  return (
    <div className="h-full flex flex-col bg-slate-100">
      <div className="bg-gradient-to-r from-blue-900 via-blue-800 to-blue-900 text-white p-4 flex flex-wrap items-center justify-between gap-4 shadow">
        ...
        <section className="bg-white rounded-2xl shadow-lg border border-slate-200 flex flex-col">
          <div className="border-b border-slate-100 p-4 flex flex-wrap items-center gap-4">
            ...
            <button
              ...
              className="px-4 py-2 bg-blue-900 text-white rounded-lg hover:bg-blue-800 shadow-sm"
            >
              Añadir producto
            </button>
        ...
        <aside className="bg-white rounded-2xl shadow-lg border border-slate-200 p-4 flex flex-col gap-4">
          ...
          <div className="mt-auto space-y-2">
            ...
            <button
              ...
              className="w-full px-3 py-3 bg-blue-900 text-white rounded-lg hover:bg-blue-800"
            >
              Remisión
            </button>
            <button
