...
class UsuarioSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'nombre_completo', 'tipo_usuario', 'telefono', 'sede',
            'is_active', 'date_joined', 'descuento_maximo'
        ]
