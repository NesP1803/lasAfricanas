...
class ConfiguracionFacturacion(models.Model):
    ...
    factus_nota_credito_document_code = models.CharField(max_length=30, blank=True, default='')
    factus_nota_credito_range_name = models.CharField(max_length=120, blank=True, default='')
    factus_nota_credito_range_prefix = models.CharField(max_length=30, blank=True, default='')
    ...
    factus_nota_debito_document_code = models.CharField(max_length=30, blank=True, default='')
    factus_nota_debito_range_name = models.CharField(max_length=120, blank=True, default='')
    factus_nota_debito_range_prefix = models.CharField(max_length=30, blank=True, default='')
    ...
    factus_documento_soporte_document_code = models.CharField(max_length=30, blank=True, default='')
    factus_documento_soporte_range_name = models.CharField(max_length=120, blank=True, default='')
    factus_documento_soporte_range_prefix = models.CharField(max_length=30, blank=True, default='')
    ...
    factus_nota_ajuste_documento_soporte_document_code = models.CharField(max_length=30, blank=True, default='')
    factus_nota_ajuste_documento_soporte_range_name = models.CharField(max_length=120, blank=True, default='')
    factus_nota_ajuste_documento_soporte_range_prefix = models.CharField(max_length=30, blank=True, default='')
