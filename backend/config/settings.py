...
FACTUS_API_VERSION = config('FACTUS_API_VERSION', default='v2')
FACTUS_SUPPORT_DOCUMENT_API_VERSION = config('FACTUS_SUPPORT_DOCUMENT_API_VERSION', default='v1')
FACTUS_SUPPORT_ADJUSTMENT_API_VERSION = config('FACTUS_SUPPORT_ADJUSTMENT_API_VERSION', default='v1')
